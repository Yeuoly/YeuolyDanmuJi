...
const initial_value = {
    ...
    loading_module : {
        ...
        speed_list_info : [
            { SPEED : 8 , INTERVAL : 1000 , PRICE_MIN : 10000 , LATIAO_MIN : 100 , NAME_CN : '极快' },
            { SPEED : 5 , INTERVAL : 500 , PRICE_MIN : 5000 , LATIAO_MIN : 50 , NAME_CN : '快' },
            { SPEED : 2 , INTERVAL : 300 , PRICE_MIN : 1000 , LATIAO_MIN : 5 , NAME_CN : '一般' },
