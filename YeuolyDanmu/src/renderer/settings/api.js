export default {
    self_proxy : 'localhost:32867',

    bili_get_room_conf : 'https://api.live.bilibili.com/room/v1/Danmu/getConf',
    bili_get_user_info : 'https://api.live.bilibili.com/user/v3/User/getMultiple',
